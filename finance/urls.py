...
from .views import IndexView, ReceitaList, DespesasView, ContatosList, CategoriaList, UsuarioView 
from .views import CategoriaCreate, ContatosCreate, ReceitaCreate
from .views import CategoriaUpdate, ContatosUpdate, ReceitaUpdate
from .views import CategoriaDelete, ContatosDelete, ReceitaDelete
